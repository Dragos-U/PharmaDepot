package com.bearsoft.pharmadepot.config.security;

import com.bearsoft.pharmadepot.services.security.JwtFilterService;
...
public class JwtFilterConfig extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            String userEmail = jwtFilterService.extractPharmacyName(jwt);
